...
%                 % Update states and control
%                 tm(i1,i2)=i1*dt;
%                 xm(i1,i2) = a(i1,i2)*t(i1,i2)^3/6 + b(i1,i2)*t(i1,i2)^2/2 + c(i1,i2)*t(i1,i2) + d(i1,i2);
%                 vm(i1,i2) = a(i1,i2)*t(i1,i2)^2/2 + b(i1,i2)*t(i1,i2) + c(i1,i2);
%                 um(i1,i2) = a(i1,i2)*t(i1,i2) + b(i1,i2);
%                 
...
% %% Define initial conditions for CAV
