%==========code used in paper for course MEEG667027stochaistic controls=============
...
a_model=-0.05;% for loop to calculate MDV model values
dt=1;
...
for i=1:length(R2_xo)
    ...
    tm_100(i)=(v100_sr(i)-v1_model(i))/a_model
